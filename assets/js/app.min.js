...
$(document).ready(function(){var e=0,t=$(".maincontent"),a=$(".page-section"),n=!1;$(".page-section:first-child").addClass("active"),$("body").on("mousewheel",function(i){var s=a.filter(".active");n||(n=!0,i.deltaY>0?s.prev().length&&e--:s.next().length&&e++);var c=100*-e+"%";a.eq(e).addClass("active").siblings().removeClass("active"),t.css("top",c),setTimeout(function(){n=!1},1300)})});