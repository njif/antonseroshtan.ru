/**
 * Anton Seroshtan <anton.seroshtan@gmail.com>
 * antonseroshtan.ru v0.0.1
 */
...
$(document).ready(function(){var e=0,n=$(".maincontent"),t=$(".page-section"),a=!1,i=0;$("body").on("touchstart",function(e){var n=e.originalEvent.touches[0]||e.originalEvent.changedTouches[0];i=n.pageY});var o=function(e){if(null!=e.deltaY)return e.deltaY>0;if(e.originalEvent){var n=e.originalEvent.touches[0]||e.originalEvent.changedTouches[0],t=n.pageY;return n.pageY=0,t-i}return!1};$(".page-section:first-child").addClass("active"),$("body").on("mousewheel touchmove",function(i){var c=t.filter(".active");a||(a=!0,o(i)>0?c.prev().length&&e--:c.next().length&&e++);var r=100*-e+"%";t.eq(e).addClass("active").siblings().removeClass("active"),n.css("top",r),setTimeout(function(){a=!1},1300)})});